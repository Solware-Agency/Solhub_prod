		...
		<div className="flex flex-col h-screen w-full bg-background">
			...
			<div className="shrink-0 bg-card/50 backdrop-blur-sm border-b border-border/50 px-4 py-3">
				<div className="flex items-center gap-3 max-w-4xl mx-auto">
					...
					{/* Título del chat */}
					<div className="w-10 h-10 rounded-xl bg-linear-to-br from-labPrimary to-labPrimary/80 flex items-center justify-center shadow-lg shadow-labPrimary/20">
				...
				<div className="max-w-4xl mx-auto">
					{messages.length === 0 && (
						<div className="text-center text-muted-foreground mt-32">
							<div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-linear-to-br from-labPrimary/10 to-labPrimary/5 flex items-center justify-center border border-labPrimary/20">
					...
					{messages.map((message) => (
						...
						>
							{message.role === 'assistant' && (
								<div className="w-9 h-9 rounded-xl bg-linear-to-br from-labPrimary to-labPrimary/80 flex items-center justify-center text-white shadow-lg shadow-labPrimary/20 shrink-0 mt-1">
					...
					<div className="flex gap-3 items-end">
						<div className="flex-1">
							<Input
								...
								disabled={isLoading}
								className="resize-none min-h-11 bg-background/80 border-border/50 focus:border-labPrimary/50 focus:ring-labPrimary/20 placeholder:text-muted-foreground/60"
							/>
						</div>
						<Button
							onClick={sendMessage}
							...
							size="default"
							className="bg-labPrimary hover:bg-labPrimary/90 text-white shadow-lg shadow-labPrimary/20 min-h-11 px-6"
						>
