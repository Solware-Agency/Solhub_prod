		...
		<>
			<div className="">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
					...
					<Card
						className="hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/20 transition-transform duration-300 shadow-lg cursor-pointer grid col-span-1 md:col-span-2 lg:col-span-3"
						...
						<CardContent>
							...
							<div className="space-y-2">
								{[
									...
									const total =
										stats.ranges.respiratoryRate.low +
										stats.ranges.respiratoryRate.normal +
						...
						<CardContent>
							...
							<div className="space-y-2">
								{[
									...
									const total =
										stats.ranges.oxygenSaturation.low +
										stats.ranges.oxygenSaturation.normal +
					...
					>
						...
						<CardContent>
							<div className="text-2xl font-bold mb-4">
								{stats.averages.bmi ? stats.averages.bmi.toFixed(1) : 'N/A'}
							</div>
							<div className="space-y-2">
								{[
									{
									...
									const total =
										stats.ranges.bmi.underweight +
										stats.ranges.bmi.normal +
										stats.ranges.bmi.overweight +
