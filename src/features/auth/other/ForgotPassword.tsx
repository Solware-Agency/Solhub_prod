	...
	const handleResetPassword = async (event: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			try {
				...
				// ignorar fallo de localStorage (privado, cuota, etc.)
			}
		} catch (err: any) {
              ...
              <div className='flex flex-col gap-2 mb-4 w-full'>
                ...
                <div className='relative'>
                  ...
                  <input
                    ...
                    required
                    disabled={loading}
                    className='w-full px-4 py-3 pl-10 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#3d84f5] focus:border-transparent transition-all duration-200'
                    autoComplete='email'
                  />
                </div>
              </div>
